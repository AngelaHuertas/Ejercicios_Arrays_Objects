...
if (cliente.has(documento)) {
    ...
    let cuentaId = Number(prompt(`Ingrese numero de cuenta: `));
            ...
            switch (menu) {
                ...
                case 2:
                    function realizarRetiro(cuenta) {
                        let retiro = Number(prompt("Ingrese el monto a retirar (Cantidades de 50,000 en 50,000 Pesos Colombianos):"));
                ...
                case 3:
                    ...
                    confirm(`¿Deseas depositar ${depositoEfectivo}?`);
                    alert(`Por favor ingrese el efectivo en la vandeja "efectivo"`);
                ...
                case 4:
                    ...
                    confirm(`¿Deseas depositar ${depositoCheque}?`);
                    alert(`Por favor ingrese el efectivo en la vandeja "chaque"`);
